...
public class DijkstraWidestPath {
    ...
    public static class Vertex implements Comparable<Vertex>{
        ...
        public int compareTo(Vertex arg0) {
            return Double.compare(this.maxWidth, arg0.maxWidth);
        }
    }
    ...
    public static void shortestPath(Vertex source, Vertex target) {
        PriorityQueue<Vertex> queue = new PriorityQueue<>(1, Collections.reverseOrder());
        source.maxWidth = Double.MAX_VALUE;
        queue.add(source);
